    ...
    mockTelegramEnv({
      ...
      launchParams: new URLSearchParams([
        ...
        ['tgWebAppData', new URLSearchParams([
          ['auth_date', '1691491200'], // Static mocked date equivalent to August 8, 2025
          ['chat_instance', '-5495965354747489443'],
          ['chat_type', 'channel'],
          ['hash', 'b1fd21d876592a90fdcad7f7cf73a39e75174ba454040e75e1acd3e4c0f46766'],
          ...
          ['user', JSON.stringify({
              ...
              language_code: 'ru',
              is_premium: true,
              photo_url: 'https://t.me/i/userpic/320/CalJuvT1dhf0jJ-mUvdOHIq-35aN2Qmh3iet_FAn7Do.svg',
